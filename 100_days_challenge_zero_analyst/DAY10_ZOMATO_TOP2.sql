...
SELECT 
	CITY_ID,  CITIES,  R_ID, R_NAME, AVERAGE_RATING
	FROM(
SELECT 
	C.CITY_ID, C.CITY_NAME AS CITIES, R.RESTAURANT_ID AS R_ID, R.RESTAURANT_NAME AS R_NAME, ROUND(AVG(O.RATING)::NUMERIC,2) AS AVERAGE_RATING,
